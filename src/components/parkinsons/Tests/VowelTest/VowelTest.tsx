...
export const VowelTest: React.FC = () => {
  ...
  const submitTest = async () => {
    ...
    try {
      ...
      formData.append('audio_file', recordedBlob, 'vowel-test.wav');
      // condition_id is optional, backend will accept null

      const response = await parkinsonApi.tests.vowel(formData);
      setResult(response);
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-900 mb-2">Vowel Test</h2>
        <p className="text-gray-600 text-sm">
          Pronounce a sustained "Ahhh" sound for 10-15 seconds
        </p>
      </div>
      ...
      <AnimatePresence>
        {result && (
          <motion.div
            ...
            className="mb-6 p-6 bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-blue-200 rounded-2xl"
          >
      ...
      {!result && (
        <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
          ...
          <ol className="text-xs text-yellow-800 space-y-1 list-decimal list-inside">
            ...
            <li>Say "Ahhh" for 10-15 seconds (as steady as possible)</li>
